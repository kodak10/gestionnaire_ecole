...
return new class extends Migration
{
    ...
    {
        Schema::create('reduction_cantines', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['inscription_id', 'annee_scolaire_id', 'ecole_id'], 'unique_reduction_cantine');
        });
    }
    ...
    {
        Schema::dropIfExists('reduction_cantines');
    }
};
