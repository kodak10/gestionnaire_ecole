...
return [
    ...
    | versions, comme les règles de taille. N'hésitez pas à modifier chaque message ici.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ici vous pouvez spécifier des messages personnalisés pour les attributs en utilisant
    | la convention "attribute.rule" pour nommer les lignes. Cela permet
    | de personnaliser rapidement un message de validation spécifique pour un attribut donné.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes permettent de remplacer les noms d’attributs par des noms plus conviviaux
    | pour les messages d’erreur. Cela rend les messages un peu plus lisibles.
    |
    */
