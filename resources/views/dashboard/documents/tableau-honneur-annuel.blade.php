...
<head>
    <meta charset="UTF-8">
    <title>Tableau d'Honneur Annuel</title>
    <style>
...
<body>
    ...
    <div class="certificate-container">
        ...
        <div class="certificate-content">
            <!-- En-tête -->
            <div class="header">
                <div class="title">Tableau d'Honneur Annuel</div>
                <div class="subtitle">Classement annuel des meilleurs élèves</div>
            </div>
            ...
            <div class="period-info">
                ...
                @else
                    Toutes classes | 
                @endif
                Année Scolaire : <strong>{{ $anneeScolaire->annee_debut }}-{{ $anneeScolaire->annee_fin }}</strong>
                <span class="annual-badge">ANNÉE COMPLÈTE</span>
            </div>
            ...
            <div class="student-section">
                ...
                <div class="student-info">
                    ...
                    <div class="student-average">
                        Moyenne annuelle : {{ $eleve['moyenne'] }}/{{ $eleve['moy_base'] }}
                    </div>
                </div>
            </div>
            ...
            <div class="message-section">
                <div class="message">
                    L'Établissement <span class="school-name">{{ $ecole->nom_ecole ?? 'GS EXCELLE' }}</span> est heureux de décerner ce diplôme d'excellence annuel et félicite 
                    <strong>{{ $eleve['inscription']->eleve->prenom }}</strong> pour son travail assidu et ses performances exceptionnelles durant 
                    <span class="period">l'année scolaire {{ $anneeScolaire->annee_debut }}-{{ $anneeScolaire->annee_fin }}</span>. 
                    Son engagement constant et ses résultats remarquables tout au long de l'année lui valent la 
                    <strong>{{ $index + 1 }}ère place</strong> dans le Tableau d'Honneur annuel de l'établissement.
                </div>
            </div>
