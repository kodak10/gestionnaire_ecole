...
<head>
    <meta charset="UTF-8">
    <title>Fiche de Fréquentation - {{ $classe->nom }}</title>
    <style>
        @page { 
            size: landscape;
            margin: 1cm; 
...
<body>
    ...
    <div class="header">
        ...
        <div class="info-classe">
            FICHE DE FRÉQUENTATION - {{ $classe->nom }} - Année Scolaire {{ $anneeScolaire->annee }}
        </div>
    ...
    <div style="margin-top: 10px; font-size: 8px;">
        <p><strong>LÉGENDE:</strong> ✅ = Présent &nbsp;&nbsp; ❌ = Absent &nbsp;&nbsp; △ = Retard</p>
    </div>
