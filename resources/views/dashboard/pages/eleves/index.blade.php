            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                ...
                <div class="dropdown me-2 mb-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                        <li>
                            <a href="" class="dropdown-item rounded-1"><i class="ti ti-file-type-pdf me-2"></i>PDF</a>
                        </li>
                        <li>
                            <a href="" class="dropdown-item rounded-1"><i class="ti ti-file-type-xls me-2"></i>Excel</a>
                        </li>
                    </ul>	
                </div>                  
                <div class="mb-2">
