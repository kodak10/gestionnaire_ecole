...
$(document).ready(function() {
    ...
    $('#classe_id').change(function() {
        ...
        if (classeId) {
            ...
            $.ajax({
                url: '{{ route("eleves.by_classe_cantine") }}',
                type: 'GET',
    ...
    function loadEleveCantineData(inscriptionId) {
        $.ajax({
            url: '{{ route("reglements.eleve_cantine_data") }}',
            type: 'GET',
            data: { 
            ...
            beforeSend: function() {
                ...
                $('#montant_cantine').val('...');
                $('#total_paye_cantine').val('...');
                $('#reste_a_payer_cantine').val('...');
            },
            success: function(response) {
                if (response.success) {
            ...
            error: function(xhr) {
                console.error('Erreur loadEleveCantineData:', xhr);
    ...
    $('#paiement-form').submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("reglements.store_paiement_cantine") }}',
            type: 'POST',
            data: formData,
            success: function(response) {
                if (response.success) {
